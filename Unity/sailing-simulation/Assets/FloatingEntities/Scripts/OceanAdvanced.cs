...
public class OceanAdvanced : MonoBehaviour
{
  ...
  static Wave[] waves =
  {
    new Wave(99, 1.0f, 0.14f, 0.9f, new Vector2(1.0f,  0.2f)),
    new Wave(60, 1.2f, 0.08f, 0.5f, new Vector2(1.0f,  3.0f)),
    new Wave(20, 3.5f, 0.04f, 0.8f, new Vector2(2.0f,  4.0f)),
    new Wave(30, 2.0f, 0.04f, 0.4f, new Vector2(-1.0f, 0.0f)),
    new Wave(10, 3.0f, 0.005f, 0.9f,new Vector2(-1.0f, 1.2f))
  };
